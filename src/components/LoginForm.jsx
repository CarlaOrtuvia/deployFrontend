...
const LoginForm = () => {
    ...
    const handleSumbit = async (e) => {
        ...
        const response = await fetch('https://back-end-n8q1.onrender.com/api/session/login', {
            method: 'POST',
            headers: {
    ...
    return (
        <>
            ...
            <section className="text-gray-400 bg-red-50 body-font py-20">
                    ...
                    <form onSubmit={handleSumbit} ref={formRef}>
                        ...
                        <div className="flex lg:w-2/3 w-full sm:flex-row flex-col mx-auto px-8 sm:space-x-4 sm:space-y-0 space-y-4 sm:px-0 items-end">
                            ...
                            <div className="relative flex-grow w-full">
                                ...
                                <input type="password" id="password" name="password" className="w-full bg-red-50 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-transparent focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
                            </div>
                            <button type="submit" className="text-white bg-red-300 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">Iniciar</button>
                        </div>
